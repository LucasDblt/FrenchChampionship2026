...
const gridsData = {
    ...
    grille_champions: [
        { id: "champ_jul", mot: "JULIETTESEBASTIEN", indice: "2024, 2025", hintText: "Pas d'indice pour les champions, fais appel à ta mémoire !", anecdote: "Juliette Sébastien a remporté les deux dernières éditions !", x: 13, y: 7, direction: "verticale" },
        { id: "champ_pie", mot: "PIERREMEUNIER", indice: "2023", hintText: "Pas d'indice pour les champions, fais appel à ta mémoire !", anecdote: "Bien joué, c'est Pierre Meunier !", x: 1, y: 25, direction: "horizontale" },
        { id: "champ_jul_d", mot: "JULESDESJARDIN", indice: "2014, 2018, 2022", hintText: "Pas d'indice pour les champions, fais appel à ta mémoire !", anecdote: "Jules Desjardin est le maître des années paires !", x: 5, y: 15, direction: "verticale" },
        { id: "champ_ale", mot: "ALEXANDRECARLIER", indice: "2013, 2015, 2016, 2017, 2019", hintText: "Pas d'indice pour les champions, fais appel à ta mémoire !", anecdote: "Alexandre Carlier a dominé la décennie 2010 !", x: 3, y: 18, direction: "horizontale" },
        { id: "champ_kan", mot: "KANNETISAEHAN", indice: "2010, 2011, 2012", hintText: "Pas d'indice pour les champions, fais appel à ta mémoire !", anecdote: "Kanneti Sae Han a réussi le triplé 2010-2012 !", x: 10, y: 22, direction: "verticale" },
